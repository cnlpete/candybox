...
namespace candybox\Module\Gallery\Controllers;
 ...
 *
 */
class Gallery extends \candyCMS\Core\Controllers\Main {
  ...
  protected function _show() {
    ...
    # Add RSS info
    $this->_aRSSInfo[] = array( 'url'   => WEBSITE_URL . '/gallery/' . $this->_aRequest['id'] . '.rss',
                                'title' => $sTitle);
   ...
   *
   */
  protected function _showFormTemplate($sTemplateName = '_form_overview', $sTitle = 'gallery.albums.title') {
