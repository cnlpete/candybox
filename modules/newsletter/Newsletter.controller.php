...
namespace candybox\Module\Newsletter\Controllers;
 ...
 *
 */
class Newsletter extends \candyCMS\Core\Controllers\Main {
  ...
  public function _create() {
    ...
    if (isset($this->_aError))
      ...
      return $this->_subscribeToNewsletter($this->_aRequest['newsletter'], true) === true ?
  ...
  protected function _showFormTemplate($sTemplateName = '_form', $sTitle = '') {
    ...
    $sName = isset($this->_aRequest['newsletter']['name']) ?
        (string) $this->_aRequest['newsletter']['name'] :
        $sName;

    $sSurname = isset($this->_aRequest['newsletter']['surname']) ?
        (string) $this->_aRequest['newsletter']['surname'] :
        $sSurname;

    $sEmail = isset($this->_aRequest['newsletter']['email']) ?
        (string) $this->_aRequest['newsletter']['email'] :
        $sEmail;
    ...
    $this->setTitle(I18n::get('newsletter.title.subscribe'));
    $this->setDescription(I18n::get('newsletter.description.subscribe'));
