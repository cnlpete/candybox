{strip}
  ...
  <table class='table'>
    ...
    {foreach $mails as $m}
      <tr class='js-tooltip' title='{$m.error_message}'>
        ...
        <td class='center'>
          <a href="#" onclick="resendMail({$m.id})">
  ...
  <script type='text/javascript'>
    $('table').tablesorter();
    function resendMail(iMailId) {
      console.log('would now try to resend the mail with id ' + iMailId);
      //TODO do ajax call to some controller action
    }
  </script>
{/strip}